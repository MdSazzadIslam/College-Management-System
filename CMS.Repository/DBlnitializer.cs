...
namespace CMS.Repository
{
    public class DBlnitializer : DropCreateDatabaseAlways <AppContext>  
    {
        protected override void Seed(AppContext context)
        {
            ...
            students.Add(new Student() { StudentId = 10001, StudentName = "A", BirthDate = DateTime.Now, RegistrationNo = "1101010" });
            students.Add(new Student() { StudentId = 10002, StudentName = "B", BirthDate = DateTime.Now, RegistrationNo = "1101011" });
            students.Add(new Student() { StudentId = 10003, StudentName = "C", BirthDate = DateTime.Now, RegistrationNo = "1101012" });
            students.Add(new Student() { StudentId = 10004, StudentName = "D", BirthDate = DateTime.Now, RegistrationNo = "1101013" });
            students.Add(new Student() { StudentId = 10005, StudentName = "E", BirthDate = DateTime.Now, RegistrationNo = "1101014" });
            students.Add(new Student() { StudentId = 10006, StudentName = "F", BirthDate = DateTime.Now, RegistrationNo = "1101015" });
            students.Add(new Student() { StudentId = 10007, StudentName = "G", BirthDate = DateTime.Now, RegistrationNo = "1101016" });
            context.Students.AddRange(students);


            teachers.Add(new Teacher() { TeacherId = 10001, TeacherName = "AAA", BirthDate = DateTime.Now, Salary = 1111111 });
            teachers.Add(new Teacher() { TeacherId = 10002, TeacherName = "BBB", BirthDate = DateTime.Now, Salary = 1111112 });
            teachers.Add(new Teacher() { TeacherId = 10003, TeacherName = "CCC", BirthDate = DateTime.Now, Salary = 1111113 });
            teachers.Add(new Teacher() { TeacherId = 10004, TeacherName = "DDD", BirthDate = DateTime.Now, Salary = 1111114 });
